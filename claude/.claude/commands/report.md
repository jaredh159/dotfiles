...
file in the root of this repo, in the format of `agent.report.{slug}.md` where slug is a
...
If there is a `agent.task.md` file in the root, make a short note referencing the new
